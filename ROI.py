...
mix_path="/home/wangjk/dataset/DenseLeaves/classification/mix"
leave_path="/home/wangjk/dataset/DenseLeaves/classification/leave"
...
for i in range(len(list_originImgsPath)):
    ...
    AddWhiteEdge(img_bin,pic_width,pic_height) # 加白边
