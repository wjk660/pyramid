...
parser.add_argument('-l', '--load-model', help='Where to load checkpoint of model from,is the prefix')
parser.add_argument('-v', '--viz-results', help='Toggle results visualization', action='store_true', default=False) # 只要传进参数的换就会使用True
