...
# args = parse_args()
saveModelName = f"Epoch{args.epochs}Pathsize{args.patch_size}allownpicNoRotationLaplacian" #保存模型名称的前缀
...
if __name__ == '__main__':
    ...
    model = PyramidNet(n_layers=5,
                       loss_weights=[torch.tensor([1.0])] * 5)  # , torch.tensor([1.1]), torch.tensor([1.8]),
